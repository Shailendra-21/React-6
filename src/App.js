...
import './App.css';
import abhiImage from "./bharath.jpg"; 
    ...
    <div className="App">
      <header>
        <div className="user">
          ...
          <h3 className="name">Bharth Reddy</h3>
        </div>
      ...
      <section className="home" id="home">
        <h3>HELLO!!</h3>
        <h1>This is <span>Bharath Reddy</span></h1>
      </section>
      ...
      <section className="about" id="about">
        ...
        <div className="row">
          <div className="info">
            <h3> <span> Name : </span> Bharath Reddy </h3>
            <h3> <span> Qualification : </span> B.Tech(pursuing) </h3>
            <h3> <span> Address</span> Godavari District</h3>
            <h3> <span> Strengths : </span> Honesty, Patience </h3>
      ...
      <section className="contact" id="contact">
        ...
        <div className="row">
          <div className="content">
            ...
            <div className="info">
              <h3> <i className="fas fa-envelope"></i> bharath291003@gmail.com</h3>
              <h3> <i className="fas fa-phone"></i> 7337223633 </h3>
              <h3> <i className="fas fa-map-marker-alt"></i> Godavari District </h3>
            </div>
          </div>
        </div>
      </section>
