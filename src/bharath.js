...
import './App.css';
import bharathImage from "./bharath.jpg";
function App() {
  ...
  return (
    <div className="App">
      <header className={`user ${isMenuOpen ? 'toggle' : ''}`}>
        <div className="user">
          <img src={bharathImage} alt="Bharath Reddy" /> {/* Replace with image URL */}
          <h3 className="name">Bharath Reddy</h3>
        </div>
      ...
      <section className="home" id="home">
        <h3>HI FRIENDS !</h3>
        <h1>I'M <span>Bharath Reddy</span></h1>
      </section>
